...
סיים בקריאה לפעולה ספציפית וברורה.`;
...
הימנע מאימוג'ים — אם משתמש, רק אחד או שניים מאוד מדויקים.
...
השתמש באימוג'ים בצורה טבעית — כמו שאנשים כותבים בוואטסאפ.
אל תשתמש בסלנג מוגזם או בבדיחות שלא מתאימות לעסק.
אל תשתמש במילים גבוהות, שיווקיות או מנופחות.
