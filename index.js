...
אין להציג כותרות פנימיות או שמות סעיפים בתוך הפוסט עצמו.
...
- השתמש באימוג'ים בצורה עשירה ונדיבה לאורך כל הפוסט — לפחות 8-10 אימוג'ים, כל אחד במקום המתאים לו בטקסט.
- אל תתייחס לתמונה עצמה בפוסט. כתוב פוסט שיווקי על העסק או המוצר, לא תיאור של מה שרואים בתמונה.
...
- מותר להשתמש בידע שיווקי כללי וסביר על סוג המוצר או העסק, אך אין להמציא מחירים, מבצעים, נתונים מקצועיים, טענות רפואיות או יתרונות ספציפיים שלא ניתן להסיק באופן סביר מהתמונה.
